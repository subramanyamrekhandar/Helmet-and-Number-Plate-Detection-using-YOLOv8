...
# Load YOLO model
MODEL_PATH = "Models/best.pt"  # Adjust this to your model path
...
# Home Page
if selected == "Home":
    st.title("Helmet and Number Plate Detection using YOLOv8 ")
    st.write("Upload an image to detect Helmet and Number Plate.")
    ...
    if upload:
        ...
        if detections:
            ...
            st.write("No helement and number plate detected.")

# About Page
elif selected == "About":
    st.title("About")
    st.write("""
    This application detects helmet and Number Plate Detection using YOLOv8. 
    Upload an image, and the system will highlight any food-related objects it detects.
    """)
